...
=======
<<<<<<< HEAD
>>>>>>> 3f74ef9b8150bc48d339398e9dbe9512bbd1133f
        <?php if(have_posts()): while(have_posts()): the_post(); ?>
          <article role="article" id="post_<?php the_ID()?>" <?php post_class()?>>
            ...
            <footer class="mt-5 border-top pt-3">
              <p><?php _e('Category: ', 'b4st'); the_category(', ') ?> | <?php if (has_tag()) { the_tags('Tags: ', ', '); ?> | <?php } _e('Comments', 'b4st'); ?>: <?php comments_popup_link(__('None', 'b4st'), '1', '%'); ?></p>
...
>>>>>>> bcf70175cd521712491e3922307d2ceeac684ca6
>>>>>>> 3f74ef9b8150bc48d339398e9dbe9512bbd1133f
      </div><!-- /#content -->
    </div>
  </div><!-- /.row -->
